...
TimeClient::TimeClient(QWidget *parent)
    : QDialog(parent)
{
    setWindowTitle(QString::fromLocal8Bit("多线程时间服务客户端"));

    serverNameLabel =new QLabel(QString::fromLocal8Bit("服务器名："));
    ...
    stateLabel =new QLabel(QString::fromLocal8Bit("请首先运行时间服务器！"));
    QHBoxLayout *layout2 = new QHBoxLayout;
    layout2->addWidget(stateLabel);

    getBtn = new QPushButton(QString::fromLocal8Bit("获取时间"));
...
void TimeClient::showError(QAbstractSocket::SocketError socketError)
{
    ...
    case QAbstractSocket::HostNotFoundError:
         QMessageBox::information(this, QString::fromLocal8Bit("时间服务客户端"),QString::fromLocal8Bit("主机不可达！"));
         break;
    case QAbstractSocket::ConnectionRefusedError:
         QMessageBox::information(this, QString::fromLocal8Bit("时间服务客户端"),QString::fromLocal8Bit("连接被拒绝！"));
         break;
    default:
        QMessageBox::information(this, QString::fromLocal8Bit("时间服务客户端"),QString::fromLocal8Bit("产生如下错误: %1.").arg(tcpSocket->errorString()));
    }
    getBtn->setEnabled(true);
}
